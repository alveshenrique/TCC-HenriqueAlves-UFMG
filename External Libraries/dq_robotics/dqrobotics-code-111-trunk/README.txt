...
This package is a wrapper of the C++ dq_robotics library, so do the steps
above for it to compile properly.

The ROS package has been updated to use catkin. So just copy the dq_robotics
to your catkin workspace source folder.
